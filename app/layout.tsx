      ...
      <body>
        <header className="site-header">
          <div className="wrapper">
            <a className="site-title" href="/">ai.engineer</a>
        ...
        <footer className="site-footer">
          <div className="wrapper">
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="https://linkedin.com/in/rishirajx" target="_blank" rel="noreferrer">
                  <svg className="social-icon" viewBox="0 0 16 16" fill="currentColor">
              ...
              <li>
                <a href="https://x.com/Infosec_Guy01" target="_blank" rel="noreferrer">
                  <svg className="social-icon" viewBox="0 0 16 16" fill="currentColor">
